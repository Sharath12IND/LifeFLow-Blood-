        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <a 
                href="#blood-facts" 
                className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 hover:text-primary-600 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium transition-colors duration-200"
                onClick={(e) => {
                  e.preventDefault();
                  const element = document.getElementById('blood-facts');
                  if (element) {
                    element.scrollIntoView({ behavior: 'smooth' });
                  }
                }}
              >
                <i className="fas fa-tint mr-1 text-primary-500"></i>
                Blood Facts
              </a>
            </div>
          </div>
      ...
      {isMenuOpen && (
        <div className="sm:hidden">
          <div className="pt-2 pb-3 space-y-1">
            ...
            >
              <i className="fas fa-tint mr-2 text-primary-500"></i>
              Blood Facts
            </a>
